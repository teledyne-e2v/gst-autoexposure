...
void algorithm_with_exposition_v3(float global_mean, int maxExp, int latency)
{
...
else
{
	...
	algorithm_without_exposition_v2(delta*global_mean,latency);
}
}
else if(global_mean<50 && proc_Once>latency)
{
	algorithm_without_exposition_v2(global_mean,latency);
}
else if(global_mean>110)
{
